...
--col_name "Qwen2.5-7B-Instruct" \
--output_dir "/scratch/qdj_project_owned_root/qdj_project_owned3/leczhang/reward_models_multilingual/qwen" \
--train_batch_size 16 \
--eval_batch_size 16 \
--max_length 512 \
...
CUDA_VISIBLE_DEVICES=0 python main_multi_metric.py \
--mode test \
--model_checkpoint "/scratch/qdj_project_owned_root/qdj_project_owned3/leczhang/reward_models_multilingual/qwen" \
--train_path "experiment2_rm_merged.jsonl" \
--col_name "Qwen2.5-7B-Instruct" \
--train_batch_size 16 \
--eval_batch_size 1 \
